...
Typical approaches:
   ...
   3. **Restore to a new cluster** — use **sstableloader** to load SSTables from backup into a new or existing cluster without replacing data dirs; useful for cloning or migrating. See [DSE Backup and Restore](https://docs.datastax.com/en/dse/5.1/managing/in-memory/backup-restore-data.html) for step-by-step procedures.
